 ...
 */
final class Version20250619045541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_83ED5D1DA66BB013 ON currency_pair (from_currency_id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_83ED5D1D16B7BF15 ON currency_pair (to_currency_id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE UNIQUE INDEX UNIQ_E9521FABA311484C ON exchange_rate (currency_pair_id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_51C18A99A311484C ON exchange_rate_history (currency_pair_id)
        SQL);
        $this->addSql(<<<'SQL'
